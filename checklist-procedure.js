            ...
            $(element).each(function stepCheck(step, indent){
                $(step).children().each(function(index, element, indent){
                    ...
                    if (tagType == "STEPTITLE") {
                        ...
                        indent += 1;
                        return stepCheck(element, indent);
                        
                    }

                    //FIXMER - not returning step output
                    return outPut;
